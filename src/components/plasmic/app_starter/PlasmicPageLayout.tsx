...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: T7-5KgjH6xY/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: 0xXj_fxp15G/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: RF_PLqAhT8l/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__rly8)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <ph.DataCtxReader>
            {$ctx =>
              true ? (
                <div className={classNames(projectcss.all, sty.freeBox__qRdw6)}>
                  <IconIcon
                    className={classNames(projectcss.all, sty.svg__lffnF)}
                    role={"img"}
                  />
                </div>
              ) : null
      ...
      >
        <ph.DataCtxReader>
          {$ctx =>
            true ? (
              <div className={classNames(projectcss.all, sty.freeBox__mf41D)}>
                {p.renderPlasmicSlot({
                  defaultContents: (
                    <section
                      className={classNames(projectcss.all, sty.section__kTqJc)}
                    >
                      <h1
                        className={classNames(
                          projectcss.all,
